...
private:
	...
	Token::pointer_type _internalAnalyzer(Tokenizer::string_type::const_iterator& currentChar, Token::pointer_type& prevToken, Tokenizer::string_type const& expression);
	Token::pointer_type _getNextToken(Tokenizer::string_type::const_iterator& currentChar, Token::pointer_type& prevToken, Tokenizer::string_type const& expression);
};
